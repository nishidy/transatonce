...
localStorage.transatonce+="\n"+c.join("\n")}else localStorage.transatonce=t.join("\n")
...
a.id=s,parent=document.getElementById("disp_parent"),parent.firstChild?parent.insertBefore(a,parent.firstChild):parent.appendChild(a),$("div#"+s).load("/trans",{word:t[e],site:o},function(i,r,d){query(e+1,t,n,o)})}function flushCacheEntries(){localStorage.clear()}function count(){var e=document.forms.trans.elements.text.value
...
localStorage.transatonce&&(e.value=localStorage.transatonce)}var timer_id
